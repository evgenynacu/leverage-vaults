...
| Interest accrual NAV inflation | general: lazy interest accrual | _forceAccrue() before every position read: processDepositEpoch, processWithdrawalEpoch, syncRedeem, depositCustom, withdrawCustom, emergencyUnwind, forceUnwind, migration flash loan amount [d:accrue-before-snap] | COVERED |
